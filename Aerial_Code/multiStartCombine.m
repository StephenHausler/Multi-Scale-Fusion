...
function [AUC,AUC_Baseline] = multiStartCombine(mainFolder,scaleArray,...
    startNum,runNum,randids,feature_type)
...
for i = 1:numScales
    if opt_useHPCfiles == 1
        load(['Extracted_Features_sameoffset_MultiStart_220220/',dataset1,'_Sqrt2_Scale_',num2str(scaleArray(i)),'_Start_',num2str(startNum),'_2013_',feature_type,'.mat']);
        feature_matrix2 = feature_matrix;
        load(['Extracted_Features_sameoffset_MultiStart_220220/',dataset2,'_Sqrt2_Scale_',num2str(scaleArray(i)),'_Start_',num2str(startNum),'_2013_',feature_type,'.mat']);
        bigfm = [feature_matrix2; feature_matrix];
        s_train{i} = bigfm; %if this was C++ I would certainly have to prealloc this
        load(['Extracted_Features_sameoffset_MultiStart_220220/',dataset1,'_Sqrt2_Scale_',num2str(scaleArray(i)),'_Start_',num2str(startNum),'_2019_',feature_type,'.mat']);
        feature_matrix2 = feature_matrix;
        load(['Extracted_Features_sameoffset_MultiStart_220220/',dataset2,'_Sqrt2_Scale_',num2str(scaleArray(i)),'_Start_',num2str(startNum),'_2019_',feature_type,'.mat']);
        bigfm = [feature_matrix2; feature_matrix];
...
save([save_name feature_type 'matchComputeTime.mat'],'time','timePerFrame');
...
if opt_saveMe == 1
    ...
    save([save_name feature_type,'_',labelid,'_results_',date,...
        '_Scales',scaleNum,'_Start',num2str(startNum),'_runNum',num2str(runNum),'.mat'],...
