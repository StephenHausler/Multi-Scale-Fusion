...
load('/home/n7542704/MATLAB_2019_Working/Multi_Scale_Fusion_Release/Urban_CropSizeTable');

load('Urban_cropSizeTable.mat');
    ...
    for j = 1:7
        ...
        if scaleCounter < 6
            if ((scaleCounter == 5) && (j >= 4))
                oNetVLAD2 = saveDbaseTemplatesMultiZoom(oNetVLAD2, cropSizeD, [saveFolder,Dataset,'_Sqrt2_Scale_',num2str(scaleCounter),'_Start_',num2str(j),'_2013_NetVLAD.mat']);
                oNetVLAD2 = saveQueryTemplatesMultiZoom(oNetVLAD2, cropSizeQ, [saveFolder,Dataset,'_Sqrt2_Scale_',num2str(scaleCounter),'_Start_',num2str(j),'_2019_NetVLAD.mat']);
            else
                oNetVLAD1 = saveDbaseTemplatesMultiZoom(oNetVLAD1, cropSizeD, [saveFolder,Dataset,'_Sqrt2_Scale_',num2str(scaleCounter),'_Start_',num2str(j),'_2013_NetVLAD.mat']);
                oNetVLAD1 = saveQueryTemplatesMultiZoom(oNetVLAD1, cropSizeQ, [saveFolder,Dataset,'_Sqrt2_Scale_',num2str(scaleCounter),'_Start_',num2str(j),'_2019_NetVLAD.mat']);           
            end    
        elseif scaleCounter < 8
            if ((scaleCounter == 7) && (j >= 4))
                oNetVLAD3 = saveDbaseTemplatesMultiZoom(oNetVLAD3, cropSizeD, [saveFolder,Dataset,'_Sqrt2_Scale_',num2str(scaleCounter),'_Start_',num2str(j),'_2013_NetVLAD.mat']);
                oNetVLAD3 = saveQueryTemplatesMultiZoom(oNetVLAD3, cropSizeQ, [saveFolder,Dataset,'_Sqrt2_Scale_',num2str(scaleCounter),'_Start_',num2str(j),'_2019_NetVLAD.mat']);
            else
                oNetVLAD2 = saveDbaseTemplatesMultiZoom(oNetVLAD2, cropSizeD, [saveFolder,Dataset,'_Sqrt2_Scale_',num2str(scaleCounter),'_Start_',num2str(j),'_2013_NetVLAD.mat']);
                oNetVLAD2 = saveQueryTemplatesMultiZoom(oNetVLAD2, cropSizeQ, [saveFolder,Dataset,'_Sqrt2_Scale_',num2str(scaleCounter),'_Start_',num2str(j),'_2019_NetVLAD.mat']);             
            end    
